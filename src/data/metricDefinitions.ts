...
export const metricDefinitions: Record<string, MetricDefinition> = {
  ...
  lifecycle_stage_users: {
    name: '生命周期阶段人数',
    definition: '各生命周期阶段用户数',
    formula: 'count(user_id by stage)',
    source: '用户事件聚合',
    refresh: 'T+1',
    note: '新注册、认证中、待申请、审核中、通过待上岗、活跃、沉睡、流失',
  },
  stage_churn_rate: {
    name: '阶段流失率',
    definition: '各阶段进入下一阶段失败比例',
  ...
  time_from_first_task_to_churn_days: {
    name: '首单到流失时长',
    definition: '首次参与任务到流失或沉睡判定的平均时长',
    formula: 'avg(churn_at - first_task_at)',
    source: '用户生命周期表 + 任务事件',
    refresh: 'T+1',
    note: '用于判断上岗后的留存质量',
  },
