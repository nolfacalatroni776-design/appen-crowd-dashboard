...
export const metricDefinitions: Record<string, MetricDefinition> = {
  ...
  funnel_new_registered_users: {
    name: '新注册用户',
    definition: '统计日前 31-60 天完成注册的去重用户数，是 D30 转化漏斗的基准用户数；该注册用户分组已完整经过注册后 0-30 天观察窗口',
    formula: 'count(distinct user_id where registered_at in cohort_range)',
    source: '用户注册事件',
    refresh: 'T+1',
    note: '不使用近 30 天新注册用户，避免注册用户分组尚未满 30 天导致 D30 状态不可观察',
  },
  funnel_verified_users_d30: {
    name: '完成实名认证',
    definition: '新注册用户分组中，注册后 30 天内完成实名认证的用户数',
  ...
  funnel_applied_users_d30: {
    name: '提交招募申请',
    definition: '新注册用户分组中，注册后 30 天内至少提交过一次招募申请的用户数',
  ...
  funnel_approved_users_d30: {
    name: '招募通过',
    definition: '新注册用户分组中，注册后 30 天内至少有一个招募申请审核通过的用户数',
  ...
  funnel_task_started_users_d30: {
    name: '参与任务执行',
    definition: '新注册用户分组中，注册后 30 天内产生首次有效任务行为的用户数',
