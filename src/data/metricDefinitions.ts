...
export const metricDefinitions: Record<string, MetricDefinition> = {
  ...
  recruitment_supply_gap: {
    name: '招募供需缺口',
    definition: '目标人数与已到位人数差额',
    formula: 'max(target_workers - onboarded_workers, 0)',
  ...
  onboard_rate: {
    name: '上岗率',
    definition: '通过后参与任务比例',
    formula: 'task_participants / approved_workers',
    source: '申请记录 + 工作流/任务',
    refresh: '30 分钟',
    note: 'demo 漏斗为参与任务执行',
  },
  ...
  lifecycle_stage_users: {
    ...
    source: '用户事件聚合',
    refresh: 'T+1',
    note: '新注册、认证中、待申请、审核中、通过待上岗、活跃、30 日未活跃、60 日沉睡、已流失',
  },
  ...
  onboarded_workers: {
    name: '已到位人数',
    definition: '通过并参与任务或自动加入任务的人数',
    formula: 'count(distinct worker with task assignment or first submit)',
    source: '工作流/任务 + 申请',
    refresh: '30 分钟',
    note: 'demo 使用“已到位”',
  },
