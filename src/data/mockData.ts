...
export const recruitTrendByDomain: Record<string, any[]> = {
  '全部领域': [
    { date: '11/1', applicants: 1180, applyRate: 14.2, passRate: 60.1, onboardRate: 80.5 },
    { date: '11/2', applicants: 1095, applyRate: 12.8, passRate: 61.5, onboardRate: 82.3 },
    { date: '11/3', applicants: 1068, applyRate: 12.5, passRate: 59.8, onboardRate: 81.2 },
    { date: '11/4', applicants: 972, applyRate: 11.2, passRate: 62.4, onboardRate: 83.5 },
    { date: '11/5', applicants: 945, applyRate: 10.8, passRate: 64.1, onboardRate: 85.6 },
    { date: '11/6', applicants: 988, applyRate: 11.0, passRate: 63.5, onboardRate: 84.8 },
    { date: '11/7', applicants: 1036, applyRate: 11.7, passRate: 62.9, onboardRate: 84.9 },
  ],
  '医疗影像': [
    { date: '11/1', applicants: 182, applyRate: 10.2, passRate: 56.1, onboardRate: 75.5 },
    { date: '11/2', applicants: 176, applyRate: 9.8,  passRate: 57.5, onboardRate: 78.3 },
    { date: '11/3', applicants: 154, applyRate: 8.5,  passRate: 55.8, onboardRate: 77.2 },
    { date: '11/4', applicants: 138, applyRate: 7.2,  passRate: 58.4, onboardRate: 76.5 },
    { date: '11/5', applicants: 132, applyRate: 6.8,  passRate: 59.1, onboardRate: 78.6 },
    { date: '11/6', applicants: 141, applyRate: 7.0,  passRate: 58.5, onboardRate: 77.8 },
    { date: '11/7', applicants: 157, applyRate: 8.2,  passRate: 58.3, onboardRate: 85.1 },
  ],
  '自动驾驶': [
    { date: '11/1', applicants: 286, applyRate: 15.2, passRate: 65.1, onboardRate: 85.5 },
    { date: '11/2', applicants: 274, applyRate: 14.8, passRate: 66.5, onboardRate: 86.3 },
    { date: '11/3', applicants: 252, applyRate: 13.5, passRate: 63.8, onboardRate: 84.2 },
    { date: '11/4', applicants: 231, applyRate: 12.2, passRate: 66.4, onboardRate: 86.5 },
    { date: '11/5', applicants: 224, applyRate: 11.8, passRate: 68.1, onboardRate: 88.6 },
    { date: '11/6', applicants: 229, applyRate: 12.0, passRate: 67.5, onboardRate: 89.8 },
    { date: '11/7', applicants: 238, applyRate: 12.3, passRate: 65.8, onboardRate: 91.2 },
  ],
  '语音合成': [
    { date: '11/1', applicants: 163, applyRate: 12.2, passRate: 58.1, onboardRate: 82.5 },
    { date: '11/2', applicants: 158, applyRate: 11.8, passRate: 59.5, onboardRate: 84.3 },
    { date: '11/3', applicants: 149, applyRate: 11.5, passRate: 57.8, onboardRate: 83.2 },
    { date: '11/4', applicants: 136, applyRate: 10.2, passRate: 60.4, onboardRate: 85.5 },
    { date: '11/5', applicants: 129, applyRate: 9.8,  passRate: 62.1, onboardRate: 87.6 },
    { date: '11/6', applicants: 133, applyRate: 10.0, passRate: 61.5, onboardRate: 86.8 },
    { date: '11/7', applicants: 140, applyRate: 10.1, passRate: 61.2, onboardRate: 88.4 },
  ],
  '文本情感': [
    { date: '11/1', applicants: 211, applyRate: 16.2, passRate: 64.1, onboardRate: 88.5 },
    { date: '11/2', applicants: 206, applyRate: 15.8, passRate: 65.5, onboardRate: 89.3 },
    { date: '11/3', applicants: 192, applyRate: 14.5, passRate: 63.8, onboardRate: 87.2 },
    { date: '11/4', applicants: 174, applyRate: 13.2, passRate: 66.4, onboardRate: 89.5 },
    { date: '11/5', applicants: 168, applyRate: 12.8, passRate: 68.1, onboardRate: 91.6 },
    { date: '11/6', applicants: 171, applyRate: 13.0, passRate: 67.5, onboardRate: 92.8 },
    { date: '11/7', applicants: 186, applyRate: 14.5, passRate: 68.1, onboardRate: 93.6 },
  ],
  '图像标注': [
    { date: '11/1', applicants: 243, applyRate: 19.2, passRate: 67.1, onboardRate: 90.5 },
    { date: '11/2', applicants: 238, applyRate: 18.8, passRate: 68.5, onboardRate: 92.3 },
    { date: '11/3', applicants: 221, applyRate: 17.5, passRate: 66.8, onboardRate: 91.2 },
    { date: '11/4', applicants: 204, applyRate: 16.2, passRate: 69.4, onboardRate: 93.5 },
    { date: '11/5', applicants: 199, applyRate: 15.8, passRate: 71.1, onboardRate: 95.6 },
    { date: '11/6', applicants: 202, applyRate: 16.0, passRate: 70.5, onboardRate: 94.8 },
    { date: '11/7', applicants: 228, applyRate: 18.2, passRate: 71.3, onboardRate: 95.8 },
  ],
  'NLP任务': [
    { date: '11/1', applicants: 162, applyRate: 23.2, passRate: 69.1, onboardRate: 93.5 },
    { date: '11/2', applicants: 158, applyRate: 22.8, passRate: 70.5, onboardRate: 95.3 },
    { date: '11/3', applicants: 145, applyRate: 21.5, passRate: 68.8, onboardRate: 94.2 },
    { date: '11/4', applicants: 130, applyRate: 20.2, passRate: 71.4, onboardRate: 96.5 },
    { date: '11/5', applicants: 126, applyRate: 19.8, passRate: 73.1, onboardRate: 98.6 },
    { date: '11/6', applicants: 129, applyRate: 20.0, passRate: 72.5, onboardRate: 97.8 },
    { date: '11/7', applicants: 139, applyRate: 22.4, passRate: 73.5, onboardRate: 98.6 },
  ]
};
